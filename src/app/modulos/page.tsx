...
const modules = [
  ...
  },
  {
    ...
    badge: 'GPS · Trazado en Vivo',
    short: 'Tracking GPS continuo en tiempo real estilo Uber con trazado de recorrido del vigilador.',
    description: 'Supervisión de patrullaje con tracking GPS continuo estilo Uber. Registra y grafica en el mapa el trazado completo del recorrido del guardia, horarios, velocidad y tiempos de permanencia en cada zona del objetivo.',
    features: [
      'Tracking GPS continuo del recorrido en tiempo real (estilo Uber)',
      'Visualización del trazado gráfico de la patrulla en el mapa',
      'Registro automático de horarios y permanencia en zonas',
      'Alertas de inactividad o desvío de ruta',
      'Historial y análisis de trazados pasados',
    ],
    benefit: 'Verificá con precisión GPS inmutable el recorrido exacto de cada patrulla en tiempo real.',
  },
  {
    icon: Globe,
    color: '#3ABEFF',
    title: 'Portal de Clientes VIP',
    badge: 'Próximamente · Expansión',
    short: 'Próximamente: Acceso exclusivo para clientes a reportes y estado del servicio.',
    description: 'Módulo en desarrollo para ofrecer a tus clientes corporativos un portal privado con acceso a toda la información de su servicio en tiempo real. Podrán consultar guardias asignados, patrullas y descargar reportes oficiales.',
    features: [
      'Login exclusivo con código de acceso para clientes',
      'Dashboard de cobertura por objetivo contratado',
      'Estado de guardias asignados en tiempo real',
      'Registro de incidentes y novedades',
      'Descarga de reportes PDF de auditoría',
    ],
    benefit: 'Próximamente disponible. Un diferenciador exclusivo para la venta corporativa.',
    comingSoon: true,
  },
  {
    icon: AlertTriangle,
