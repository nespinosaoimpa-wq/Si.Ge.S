...
import { 
  ...
  CheckCircle2, Clock, Box, Home, Car, Bike, UserCheck, User, Tag, Flame, Wrench, Radio, Layers
} from 'lucide-react';
    ...
    <div className="p-6 lg:p-10 space-y-8 max-w-[1600px] mx-auto min-h-screen bg-zinc-50 font-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          >
            <Tag size={18} className="text-[#0F4C5C]" />
            Cargar Categorías
          </button>
          <button 
      ...
      {/* MODAL / SHEET: GESTIÓN Y CARGA DE CATEGORÍAS */}
      <BottomSheet 
        ...
        <div className="space-y-6 pb-12 font-sans">
          ...
          <form onSubmit={handleCreateCategory} className="bg-zinc-50 p-6 rounded-3xl border border-zinc-200 space-y-4">
            ...
            <Button 
              ...
              className="w-full h-12 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-black uppercase text-xs tracking-widest shadow-md"
            >
